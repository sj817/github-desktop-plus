      ...
      <div className="relative flex min-w-0 flex-1 flex-col bg-canvas">
        <Tooltip content="关闭 (Esc)">
          <Button
            ...
            variant="ghost"
            aria-label="关闭"
            className="absolute top-3.5 right-3.5 z-10 size-7 rounded-full text-fg-subtle hover:text-fg hover:bg-hover"
        ...
        <footer className="flex h-[48px] shrink-0 items-center gap-2 border-t border-line px-5 @max-[620px]:px-4">
          <Button
            variant="link"
            size="sm"
            className="px-1 text-[11.5px] font-medium"
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col">
      ...
      <main
        ...
        className={cn(
          'min-h-0 flex-1 animate-page-in px-7 pt-4 @max-[620px]:px-5',
